...
public class IncomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(IncomeActivity.this, Home.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void getFormWidgets()
    {
        ...
        editCv=(EditText) findViewById(R.id.content);
        editNd=(EditText) findViewById(R.id.amount);
        btnDate=(Button) findViewById(R.id.btndate1);
        btnTime=(Button) findViewById(R.id.btntime1);
        btnAdd=(Button) findViewById(R.id.btnadd1);
        lvCv=(ListView) findViewById(R.id.lvincome);
